...
public abstract class Algorithm {
	...
	public Path getPath(Map map, String initialIntersection, String finalIntersection, int maxSpeed) {
		...
		//Falta cambiar este elemento por una lista de intersections 
		...
		//TODO: Cambiar la nueva lista de intersecciones por algo razonable
		return new Path(new ArrayList<Intersection>(), graphicalPath, segmentPath);
	}
