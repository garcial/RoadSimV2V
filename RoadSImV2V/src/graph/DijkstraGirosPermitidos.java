...
public class DijkstraGirosPermitidos {
	...
	/**
	 * El algoritmo se basa en el cap�tulo 3 de Inteligencia Artificial para
	 * desarrolladores. Conceptos e implementaci�n en C#
	 * */

	    private List<Node> nodes;
	    private Set<Node> unSettledNodes;
	    private Map<Node, Node> predecessors;
	    // La key de las distancias es el id de la intersecci�n - id del segmento
	    // El segmento que se utiliza en las distacias es que segmento por el cual llegas a esa intersecci�n
	    //En el caso de que sea el primer nodo que pongo �Solo el nombre de la intersecci�n 0 o los de entrada?
	    ...
	    public DijkstraGirosPermitidos(MultiGraphRoadSim graph) {
	    	...
	    	// {Intersecci�n origen, destino, id, peso}
	        ...
	        for(Edge i : graph.getEdges()){
	        	...
	        	// Cada nodo en realidad engloba el camino por donde viene es decir cada intersecci�n
	    ...
	    /**
	     * Este m�todo busca el nodo con menor peso de los no recorridos
	     * */
	    ...
	    /**
	     * Este m�todo b�sca el camino con menor peso
	     * */
	    ...
	    /**
	     * Consigue los vecinos de un nodo espec�fico
	     * */
	    ...
	    private double getDistance(Node node, Node target) {
	    	...
	    	String[] nodeParts = node.getId().split("¿"); // En el caso del primer nodo solo tiene la id de la intersecci�n
