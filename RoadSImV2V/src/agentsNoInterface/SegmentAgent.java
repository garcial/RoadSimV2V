...
import behavioursNoInterface.SegmentListenBehaviour;
import behavioursNoInterface.SegmentRadarBehaviour;
import behavioursNoInterface.SegmentSendToDrawBehaviour;
import environment.SegmentNoInterface;
...
public class SegmentAgent extends Agent {
	...
	private SegmentNoInterface segment;
	...
	protected void setup() {
		...
		this.segment = (SegmentNoInterface) this.getArguments()[0];
		...
		sd.setType("segmentAgentNoInterface");
	...
	//Getters and setters
	public SegmentNoInterface getSegment() {
		return segment;
	}

	public void setSegment(SegmentNoInterface segment) {
